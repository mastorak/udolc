...
import logging
logger = logging.getLogger('udolc_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by UdolcWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseUdolcWindow object.
        """
        builder = get_builder('UdolcWindow')
        new_object = builder.get_object("udolc_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a UdolcWindow object with it in order to finish
        initializing the start of the new UdolcWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.udolc")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('udolc')
        except ImportError:
            pass
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for udolc."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for udolc."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the UdolcWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the UdolcWindow is closed."""
